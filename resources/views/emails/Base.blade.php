...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #ffffff;">
    <center style="width: 100%; background-color: #dedede;padding-top: 50px;">
        <!--[if mso | IE]>
        ...
        <div
            ...
            seems like a better UX for anyone using
            a screenreader or voice-command apps like Siri to dictate the contents of an email. If this text is not
            included, email clients will automatically populate it using the text (including image alt text) at the
            start of the email's body.
        </div>
        ...
        <div style="max-width: 680px; margin: 0 auto;" class="email-container">
            ...
            <img style="margin-bottom: 1em;max-width: 50vw;"
                src="{{ $message->embed(base_path('/public/logo.png')) }}" />
                ...
                <tbody>
                    <tr>
                        <td style="background-color: #ffffff; text-align: center;">
                            ...
                            <h1
                                style="margin: 0 0 10px 0; font-family: Helvetica, sans-serif; line-height: 22px; color: #ffffff; font-weight: bold;padding: 35px 0;background: var(--primary-color);">
                                {{ $title }}
                            </h1>
                        </td>
                    </tr>
                        ...
                        <div align="center" style="max-width: 680px; margin: 0 auto;" class="email-container">
                            ...
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"
                                ...
                                <tbody>
                                    <tr>
                                        <td
                                            style="padding: 20px;font-family: Helvetica, sans-serif;font-size: 12px;line-height: 15px;text-align: center;color: #d2d2d2;">
                                            <br><br> Bookstore<br></span>
                                            <br><br>
                                        </td>
                                    </tr>
                                </tbody>
